 ...
 *   2. "recognize" — камера → распознавание жеста по эталонам из «Обучи».
 *
 * В подрежиме "recognize" используется тот же TemplateMatcher, что и в
 * TemplateMode (вкладка «Интерактив» → «Обучи»). Это значит:
 *   - распознавание работает по тем же эталонам, что записаны в «Обучи»;
    ...
    <div style={styles.body}>
      ...
      {recordings.length === 0 && (
        <div style={styles.warn}>
          Нет записанных жестов. Перейдите на вкладку «Интерактив» → «Обучи»,
        ...
        <div style={styles.queueBox}>
          ...
          {missingCount > 0 && status === "idle" && (
            <div style={{ fontSize: 11, color: "#ef4444", marginTop: 6 }}>
              Не найдено жестов: {missingCount}. Запишите их во вкладке «Обучи».
            </div>
          )}
        </div>
      )}
    ...
    <div style={styles.body}>
      ...
      {templatesCount === 0 ? (
        <div style={styles.warn}>
          ...
          «Интерактив» → «Обучи» и при сохранении согласитесь добавить
          их как анимации.
        </div>
      ) : (
        <>
